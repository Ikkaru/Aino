...
from config import CHUNK_FILE, CHUNKING_INSTRUCTION, PROJECT_ROOT
from dotenv import load_dotenv


dotenv_path = load_dotenv(dotenv_path=PROJECT_ROOT/".env")
...
prompt = load_system_prompt(CHUNKING_INSTRUCTION)
